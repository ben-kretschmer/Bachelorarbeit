...
Ziel der Arbeit ist die Quantifizierung und der Vergleich der Anbieterbindung (englisch: Vendor-Lock-In) bei führenden Cloud-Computing-Anbietern insbesondere SaaS-Anbietern.
...
Außerdem wurden führende Cloud-Computing-Anbieter vorgestellt. 
...
Danach wurde die vorgeschlagene Lösung zur Quantifizierung von Anbieterbindung, einem Bewertungsmodell, schrittweise entwickelt.
...
Aus der Untersuchung geht hervor, dass das Risiko für Anbieterbindung bei den führenden Anbietern zwischen 60\% und 80\% liegt.
