...
Im Kontext dieser Arbeit wird eine gleiche Gewichtung aller Kriterien im Katalog konfiguriert. Alternativen zu dieser Herangehensweise werden diskutiert.
\begin{figure}
\begin{center}
...
\paragraph{Theorie der Umrechnung der Bewertungen}
...
\paragraph{Folgerungen aus den Ergebnissen}
Die Ergebnisse lassen sich auf zwei Wege interpretieren.
Einerseits deuten die gleichen Ergebnisse darauf hin, dass die Anbieter individuell einen erhöhten Grad der Anbieterbindung entwickelt haben, der Cloud-Computing-Kunden effektiv bindet.
Es wäre auf Basis der Ergebnisse annehmbar, dass dieser Grad der Anbieterbindung eine Strategie zur Kundenbindung ist. (vergleiche Abschnitt \ref{Anbieterbindung-Def}

Andererseits ist es möglich, dass dieser Grad der Anbieterbindung, implizit diese Mischung aus proprietärer und freier Software, das Ergebnis der Feinjustierung der Wirtschaftlichkeit und Kundenwünsche ist.

Zuletzt wird angemerkt, dass diese Ergebnisse auch durch Fehler in der Methodik dieser Arbeit entstanden sein könnten.
Die Produktkataloge der jeweiligen Anbieter sind sehr umfangreich und der Kriterienkatalog umfasst 45 Kriterien.
(vergleiche Google Cloud mit über 150 Produkten \parencite{GoogleKat2026})
Mit diesem Hintergrund ist annehmbar, dass die Abbildung nicht präzise genug sein könnte.
...
Die Effektivität des Modell wurde im Ansatz durch die herangezogene Untersuchung untermauert.
