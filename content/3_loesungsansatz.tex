...
Die entwickelten Formulare sind zum Vergleich dieser Arbeit angehängt.

\paragraph{Änderungen und Anpassungen}
Die Gesamtbewertung in Prozent wurde zur intuitiven Ablesung von 100\% abgezogen (Bildung der \glq invertierten\grq\ Bewertung).
...
(vergleiche Abbildung \ref{vendor-lock-in-score} und \ref{oss-score})
