...
Für die Untersuchung wurden Geschäftsführer und IT-Führungskräfte aus 503 Unternehmen befragt. \cite{StatistaCCNutzung2024}
...
Die Abbildung \ref{A-cloud-stack} zeigt eine eigene Übersicht über verschiedene Modelle der Cloud-Computing-Architektur
basierend auf der ISO-Norm zu Cloud Computing. \cite{ISO22123}.
Dabei ist farblich (rot) hervorgeheben, welche Komponenten jeweils vom Cloud-Computing-Anbieter verwaltet werden.
Die übrigen Komponenten werden durch den Kunden selbst verwaltet. \cite{Cloud1012026}

\begin{figure}
\begin{center}
\includegraphics[width=0.75\linewidth]{figures/CloudStack}
\end{center}
\label{A-cloud-stack}\caption{Übersicht über verschieden Verwaltungsformen der Cloud}
\end{figure}
...
Stattdessen hat der Cloud-Kunde bei der Verwendung der Public Cloud den Zugriff auf einen öffentlichen Vorrat aus Rechenressourcen.

Im Gegensatz hierzu wird der Umfang der Rechenressourcen bei der Private Cloud festgelegt und dann für den Kunden fest zugeorndet.

Neben der Verwendung eines einzigen Cloud-Anbieters kann ein Unternehmen auch andere Architekturen wählen.
Dazu zählen die simultane Verwendung von Public und Private Cloud, sowie eigener Rechenzentren,
was als Hybride Cloud bezeichnet wird. \cite{Cloud1012026}
...
Bei Hybride Cloud und Multi-Cloud ist vorteilhaft, dass Alleinstellungsmerkmale mehrerer Anbieter gleichzeitig genutzt werden können
und die Vorzüge der jeweiligen Modelle kombiniert werden können.
Jedoch kommt die Verwendung solcher Ansätze auch mit höherem organisatorischen Aufwand, es müssen verschiedene Geschäftsbeziehungen gepflegt werden
und die Verknüpfung der verschiedenen Produkte kann zusätzliche Kosten und Aufwand mit sich bringen.
Außerdem kann der Verbindungskanal zwischen Produkten von verschieden Anbietern ein Flaschenhals und eine Schwachstelle sein.
...
Diese Fallen wiederrum bei der Integration von Cloud-Computing im Unternehmen teilweise oder vollständig an.
Zu welchem Grad Kosten eigener Infrastruktur und Software wegfallen, hängt vom Grad der Integration der Cloud ab.

So werden für die erfolgreiche Integration von Cloud-Computing Mitarbeitende mit neuen Kompetenzen benötigt. Zu diesen Kompetenzen zählt die Kontrolle, Regulierung und Überwachung der Dienstleistungsvereinbarungen (kurz: SLA) mit den Cloud-Computing-Anbietern und der Cloud-Computing-Nutzung durch das Unternehmen. \cite{Mezzio2023}

Auch zu beachten ist, dass Schulungen für die neuen Bedienoberflächen der SaaS-Anbieter notwendig werden. Hat der gewählte Anbieter größtenteils eigene Software im Angebot, so gibt es entsprechend wenige Optionen für Schulungsanbieter.

In der Summe lässt sich annehmen, dass finanzielles Risiko und große anfängliche Investitionen für Unternehmen wegfallen, jedoch ist ein vollständiger Kostenvergleich nicht Gegenstand dieser Arbeit.
 
\subparagraph{Skalierbarkeit}
Bei herkömmlichen Architekturen mit Hardware und Software in eigner Verwaltung durch das Unternehmen oder den IT-Dienstleister ist die Herausforderung bezüglich der Skalierung erfahrungsgemäß der fehlende Vorrat freier Rechenressourcen.
...
Bei technischen Fehlfunktionen, Schäden durch Feuer oder Wasser,
oder bei Verschlüsselung von Daten ist es wichtig eine Momentaufnahme der eigenen Systeme zu haben, 
...
Die Abbildung zeigt außerdem weniger weit verbreitete Maßnahmen wie Intrusion Detection System (IDS) oder die Verwendung von Penetrationstests. \cite{StatistaSecMassnahmen2018}
...
Letzeres ist ein Punkt der ein großes Gewicht hat, denn Fachpersonal ist oftmals eine Hürde bei der Digitalisierung allgemein und damit auch speziell bei Sicherheitsmaßnahmen \cite{StatistaHuerden2025}
...
Außerdem werden im ursprünglich zitierten Kaptiel noch \glqq Vorteile der Cloud\grqq\ wie \glq Internet of Things\grq -Funktionalitäten, verbesserte Zusammenarbeit, Umweltfreundlichkeit, Mitarbeiter-Engagement, Echtzeit-Software-Updates und Analyse-Möglichkeiten angesprochen. \cite{Mezzio2023}
...
Besonders hervorzuheben ist der letzte Platz der Auflistung, der wie auch bei anderen Vorteilen bereits, durch Produkte bei vielen Anbietern ermöglicht wird. Die Analyse von Daten, Netwerkverkehr oder sonstigen Informationen wird durch eigene Produkte für die Kunden von SaaS-Anbietern stark vereinfacht und zugänglicher gemacht.

\paragraph{Kapitalisierung der Cloud}
Aus dem Paradigma Cloud Computing und den verschiedenen in Abschnift \ref{}
...
Grundlegend kann gewählt werden wie viele Schichten des ursprünglichen Rechenzentrums in die Cloud gehoben werden sollen. (vergleiche \ref{A-cloud-stack})
